...
def main():
    ...
    print('Joe logged in?', authenticator.is_logged_in("joe"))
    # authenticator.login("joe", "wrongpassword")
    ...
    print('Joe permitter to paint?', authorizor.check_permission("paint", "joe"))
